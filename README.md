...
```bash
npm install @yourorg/design-tokens
```
...
```css
@import '@yourorg/design-tokens/css/design-system.css';

/* Or import individually */
@import '@yourorg/design-tokens/css/foundations.css';
@import '@yourorg/design-tokens/css/themes.css';
@import '@yourorg/design-tokens/css/utilities.css';
```

### JavaScript integration
```javascript
import { setTheme, setColorScheme } from '@yourorg/design-tokens'
...
### React
```jsx
import { useTheme } from '@yourorg/design-tokens'
import '@yourorg/design-tokens/css'
...
<script setup>
import { ref } from 'vue'
import { setTheme } from '@yourorg/design-tokens'

const currentTheme = ref('warm')
const updateTheme = () => setTheme(currentTheme.value)
</script>
```
